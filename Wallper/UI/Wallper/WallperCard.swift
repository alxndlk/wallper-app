...
struct WallperCard: View {
    ...
    static private let cacheDirectory = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first!
    static private let previewsFolder = cacheDirectory.appendingPathComponent("Previews")
