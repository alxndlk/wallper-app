...
struct UploadView: View {
                            ...
                            VStack(alignment: .leading, spacing: 16) {
                                VStack(alignment: .leading, spacing: 12) {
                                    Text("My Uploaded Videos")
                                        .font(.title2.bold())
                                        .foregroundColor(.white)
                                    Text("Browse through your recently uploaded videos. Manage, edit, or delete your content anytime, and easily share it with others.")
                                        .foregroundColor(.white.opacity(0.7))
                                        .font(.system(size: 14))
                                }

                                LazyVGrid(columns: Array(repeating: .init(.flexible()), count: 6), spacing: 24) {
    ...
    private var descriptionSection: some View {
        HStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("Upload your own stunning 4K videos and set them as live wallpapers. Each upload can be up to 500MB in size. Supported format: MP4. After uploading, you can preview, edit metadata, and publish your creation.")
                    .foregroundColor(.white.opacity(0.7))
                    .font(.system(size: 14))
            }
            .frame(width: 650)
    ...
    private var features: [(icon: String, title: String, subtitle: String)] {
        [
            ("sparkles", "4K Resolution", "Upload ultra HD videos."),
            ("bolt", "Fast Uploads", "Up to 500MB per file."),
            ("lock.shield", "Secure Upload", "Your data is protected."),
            ("icloud", "Cloud Storage", "Your uploads anywhere."),
            ("wand.and.stars", "Enhancements", "Improve video quality."),
            ("eye.slash", "Privacy First", "Only you see your files.")
        ]
    }
}
